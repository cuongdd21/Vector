...
class SessionController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['Session'])) {
            ...
            $day_new_model = Term::model()->getLatest()->weeks[$week_new - 1]->days[$day_new -
                1];
    ...
    public function actionDelete($id)
    {
        ...
        $this->redirect(array('manage/manageDisplayMessage', 'message' =>
                'The Session is successfully deleted!'));
