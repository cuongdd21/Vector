    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Lesson'])) {
            ...
            for ($i = $start_week; $i < $end_week + 1; $i++) {
                ...
                if (($session != null)) {
                    throw new CHttpException('Unable to enrol this Lesson due to Week ' . ($i + 1) .
                        ' ' . getDayText($day + 1) . ' Slot is not available!');
                }
            }
            ...
            if (isset($_POST['pricePackage']) && isset($_POST['priceGroup']) && isset($_POST['priceDegree'])) {
                ...
                throw new CHttpException('Unable to input price list');
            ...
            if ($model->save()) {
                ...
                // create invoice
                $lastInvoice = Invoice::model()->findAll(array('order' => "id DESC", 'limit' =>
                        1));
                if (!$lastInvoice)
                    $latest_id = 0;
                else
