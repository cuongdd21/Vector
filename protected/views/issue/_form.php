...
<?php 
echo $form->dropDownList($model,'type_id', $model->getTypeOptions()); 
?>
...
<!--nhung truong nhu la create_time, create_user_id, update_time, update_user_id se duoc tuy bien tu dong khong can input-->
